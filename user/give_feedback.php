...
{
$query="insert into feedback values('','$user','$faculty','$quest1','$quest2','$quest3','$quest4','$quest5','$quest6','$quest7','$quest8','$quest9','$quest10','$quest11','$quest12','$quest13',now())";
...
<form method="post">
<fieldset>
<center><u style="    font-family: inherit;
    font-size: 25px;
    text-decoration: none;
    color: brown;">Student's FeedBack Form</u></center><br>
...
<tr>
<td><b>1:</b> Has The Teachers Coverd entire Syllabus as prescirbed by college ?</td>  
...
<tr>
<td><b>2:</b>Has the Teacher covered relvent topics beyond syllabus : </td> 
...
<tr>
<td>
<b>3:</b>Completes syllabus of the course in time :</td> 
<td>
...
<tr>
<td>
<b>5:</b> Motivational and inspriation for students to learn :</td>
<td> 
...
<tr>
<td>
<b>9:</b>  Support for the devleopment of student's skills :</td> 
...
<textarea name="quest13" rows="5" cols="60" id="comments" placeholder="Enter Your Comment" style="font-family:sans-serif;font-size:1.2em;">

</textarea>

<br><br><br>
<p align="center"><button type="submit" style="font-size: 11pt;
    color: white;
    background-color: brown;
    border: 2px solid #336600;
    padding: 6px 10px;" name="sub">Submitt</button></p>
