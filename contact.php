...
">
            <div class="col-md-8">
                <h2><font color="#000">Contact us </font></h2>
                <form name="sentMessage"  class="cform" method="post" id="contactForm" novalidate>
                  <?php echo @$err; ?>
			...
			<div class="col-md-4" style="margin-top:65px">
                ...
                <p>
                    Goverment Polytecnic College Kota<br>Rajasthan, India <br>
                </p>
                <p><i class="fa fa-phone"></i> 
                    <abbr title="Phone">P</abbr>: +91 ..........</p>
                <p><i class="fa fa-envelope-o"></i> 
                    <abbr title="Email">E</abbr>: <a href="mailto:name@example.com">name@example.com</a>
                </p>
                <p><i class="fa fa-clock-o"></i> 
                    <abbr title="Hours">H</abbr>: Monday - Saturdayt: 9:00 AM to 9:00 PM</p>
