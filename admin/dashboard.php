...
<body>
    ...
    <div id="wrapper">
        ...
        <!-- Navigation -->
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0;background:cornflowerblue" >
...
<li><a href="dashboard.php?info=feedback_average"><i class="fa fa-eye"></i> feedback Average</a></li>
        ...
        <div id="page-wrapper" style="background:darkgrey">
            <div class="row">
                <div class="col-lg-12">
